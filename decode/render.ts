...
METRIC_MAP[Metric.Calls] = { name: "Calls" };
METRIC_MAP[Metric.LongTasks] = { name: "Long Calls" };
METRIC_MAP[Metric.Cost] = { name: "Cost", unit: "ms"};
METRIC_MAP[Metric.DiscoverCost] = { name: "Discover Cost", unit: "ms"};
METRIC_MAP[Metric.MutationCost] = { name: "Mutation Cost", unit: "ms"};
METRIC_MAP[Metric.BoxModelCost] = { name: "BoxModel Cost", unit: "ms"};
METRIC_MAP[Metric.MaxBlockTime] = { name: "Max Block Time", unit: "ms"};
